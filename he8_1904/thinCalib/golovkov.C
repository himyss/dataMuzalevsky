...
void golovkov() {
  ...
  readPar("pedestals1",p1,temp);
  readPar("pedestals2",p2,temp);
  readPar("pedestals3",p3,temp);
  readPar("pedestals4",p4,temp);
  cout << endl;

  TChain *ch1 = new TChain("tree"); //e4
  ch1->Add("/home/oem/work/data/exp1904/clb/analysed/20um_1mm_selected.root");
  ...
  for(Int_t i=0;i<10;i++) {
    ...
    histName.Form("h%d",i);
    hDraw.Form("(a20_1.*%f) + %f>>h%d(300,1,6)",oldpar2[i],oldpar1[i],i);
