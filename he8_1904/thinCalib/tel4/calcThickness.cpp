...
// //
  ...
  c[0]->cd(1);
  ch0->Draw("a4>>edepN(300,1,9)","n4==7 && n20_4==7","");
...
//SetBinContent(Int_t binx, Int_t biny, Double_t content)
  ...
  // outfile
  TFile *fw = new TFile("/home/oem/work/software/AculUti/data/thickness4.root", "RECREATE");
  if (fw->IsOpen() == 0) {
