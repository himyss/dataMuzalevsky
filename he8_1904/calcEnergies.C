...
void calcEnergies() {
  ...
  TFile *fw = new TFile("/home/oem/work/data/exp1904/analysed/h7/h7_reco.root", "RECREATE");
  ...
  for(Int_t nentry = 0; nentry<ch->GetEntries();nentry++) {
    ...
    if(nhe3_1) {
      ...
      e_1 = f3HeSi->GetE0(a1_1,1.5/cos(th_he3_1)) + a20_1_un; // 4 micron - DL between thin and thick sensitive areas (DL thin about 1 mik)
    ...
    if(nhe3_2) {
      // Si
      e_2 = f3HeSi->GetE0(a1_2,1.5/cos(th_he3_2)) + a20_2_un; // 4 micron - DL between thin and thick sensitive areas (DL thin about 1 mik)
    ...
    if(nhe3_3) {
      // Si
      e_3 = f3HeSi->GetE0(a1_3,1.5/cos(th_he3_3)) + a20_3_un; // 4 micron - DL between thin and thick sensitive areas (DL thin about 1 mik)
    ...
    if(nhe3_4) {
      // Si
      e_4 = f3HeSi->GetE0(a1_4,1.5/cos(th_he3_4)) + a20_4_un; // 4 micron - DL between thin and thick sensitive areas (DL thin about 1 mik)
    ...
    if(nh3) {
      // Si
      thickness = 1500/cos(th_h3);
      centE = f3HeSi->GetE0dE(X_C,thickness); // 4 micron - DL between thin and thick sensitive areas (DL thin about 1 mik)
