...
//     }
  ...
  if (he3_2) {
    ...
    ch->SetMarkerStyle(6); 
    ch->SetMarkerColor(kBlack);      
    cut.Form("n20_2==%d && a1_2+a20_2_un<45 && flag2 && a20_2<4 && multv_2==0",i);
    cut += " && ((fXt-0.467)*(fXt-0.467) + (fYt-0.026)*(fYt-0.026))<9*9 ";
    hdraw.Form("a20_2:a1_2+a20_2_un>>h%d_he32",i);
    ch->Draw(hdraw.Data(),cut.Data(),"");
    c1->Update();
   ...
   if (he3_3) {
    ...
    ch->SetMarkerStyle(6); 
    ch->SetMarkerColor(kBlack);      
    cut.Form("n20_3==%d && a1_3+a20_3_un<45 && flag3 && a20_3<4 && multv_3==0",i);
    cut += " && ((fXt-0.467)*(fXt-0.467) + (fYt-0.026)*(fYt-0.026))<9*9 ";
    hdraw.Form("a20_3:a1_3+a20_3_un>>h%d_he32",i);
    ch->Draw(hdraw.Data(),cut.Data(),"");
    c1->Update();
  }
  ...
  if (he3_4) {
    ...
    cut += " && ((fXt-0.467)*(fXt-0.467) + (fYt-0.026)*(fYt-0.026))<9*9 ";
    hdraw.Form("a20_4:a1_4+a20_4_un>>h%d_he32",i);
    ch->Draw(hdraw.Data(),cut.Data(),"");
    c1->Update();
  }
