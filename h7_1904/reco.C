...
void reco() {
  ...
  // ch->Add("/media/ivan/data/exp1904/analysed/MKpars/reco_25.root");
  ch->Add("/media/ivan/data/exp1904/analysed/oldPars/reco.root");
  ...
  TFile *fw = new TFile("/media/ivan/data/exp1904/analysed/oldPars/mm.root", "RECREATE");
  // TFile *fw = new TFile("/media/ivan/data/exp1904/analysed/MKpars/mm.root", "RECREATE");
  // TFile *fw = new TFile("/media/ivan/data/exp1904/analysed/oldPars/mm.root", "RECREATE");
