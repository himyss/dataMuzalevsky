...
void convert() {
  ...
  ch->Add("/home/oem/work/data/exp1904/digi/h7/h7_ct_*");

  cout << "Found " << ch->GetEntries() << " entries" << endl;

  readPar("DSD_X",pDSDX_C1,pDSDX_C2,32);
  readPar("DSD_Y",pDSDY_C1,pDSDY_C2,32);
...
//--------------------------------------------------------------------------------
  ...
  TFile *fw = new TFile("/home/oem/work/data/exp1904/analysed/beamRates/h7_ct_13-15.root", "RECREATE");
