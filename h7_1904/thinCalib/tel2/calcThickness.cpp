...
// //
  ...
  c[0]->cd(1);
  ch0->Draw("a2>>edepN(300,1,9)","n2==7 && n20_2==7","");
...
//SetBinContent(Int_t binx, Int_t biny, Double_t content)
  ...
  // outfile
  TFile *fw = new TFile("/home/oem/work/software/AculUti/data/thickness2.root", "RECREATE");
  if (fw->IsOpen() == 0) {
