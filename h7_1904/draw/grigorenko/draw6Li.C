void draw6Li(){
  ...
  //--------------------------------------------------------------------------------
    ...
    TCanvas *c_mm,*c_mm_diff,*cRangle,*cRangle_diff,*c_proj;
    ...
    if (mm_7h) {
        ...
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        // cut += " && " + cutTriangle1;
        cout << ch1->Draw("1000*(mh7-4*0.939565) >> mm_full",cut.Data(),"") << endl;
        c_mm->Update(); 
        ...
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        // cut += " && " + cutTriangle1;
        cout << ch1->Draw("1000*(mh7-4*0.939565) >> mm_full2",cut.Data(),"") << endl;
        c_mm->Update();  
...
return;
        ...
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cout << ch1->Draw("1000*(mh7-4*0.939565-2.808920) >> mm_1(25,-4.33,20.67)",cut.Data(),"") << endl;
        c_mm_diff->Update();    
        ...
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";      
        cout << ch1->Draw("1000*(mh7-4*0.939565-2.808920) >> mm_2(25,-4.33,20.67)",cut.Data(),"") << endl;
        c_mm_diff->Update();    
        ...
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cout << ch1->Draw("1000*(mh7-4*0.939565-2.808920) >> mm_3(25,-4.33,20.67)",cut.Data(),"") << endl;
        c_mm_diff->Update();    
        ...
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cout << ch1->Draw("1000*(mh7-4*0.939565-2.808920) >> mm_4(25,-4.33,20.67)",cut.Data(),"") << endl;
        c_mm_diff->Update();    
    ...
    if (reactionAngle) {
        ...
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cut += " && " + cutTriangle1;
        cout << ch1->Draw("thetah7CM:1000*(mh7-4*0.939565-2.808920) >> h_thetah7CM",cut.Data(),"") << endl;
        htemp2 = (TH2F*)gPad->GetPrimitive("h_thetah7CM");
        // htemp2->GetXaxis()->SetRangeUser(-7,17);
        // htemp2->GetYaxis()->SetRangeUser(3,45);
        cRangle->Update();
        ...
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cut += " && " + cutTriangle1;        
        cout << ch1->Draw("thetah7CM:1000*(mh7-4*0.939565-2.808920) >> h_thetah7CM1",cut.Data(),"") << endl;
        htemp2 = (TH2F*)gPad->GetPrimitive("h_thetah7CM1");
        htemp2->GetXaxis()->SetRangeUser(-7,17);
        htemp2->GetYaxis()->SetRangeUser(3,45);
        cRangle_diff->Update();
        ...
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cut += " && " + cutTriangle1;        
        cout << ch1->Draw("thetah7CM:1000*(mh7-4*0.939565-2.808920) >> h_thetah7CM2",cut.Data(),"") << endl;
        htemp2 = (TH2F*)gPad->GetPrimitive("h_thetah7CM2");
        htemp2->GetXaxis()->SetRangeUser(-7,17);
        htemp2->GetYaxis()->SetRangeUser(3,45);
        cRangle_diff->Update();
        ...
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cut += " && " + cutTriangle1;        
        cout << ch1->Draw("thetah7CM:1000*(mh7-4*0.939565-2.808920) >> h_thetah7CM3",cut.Data(),"") << endl;
        htemp2 = (TH2F*)gPad->GetPrimitive("h_thetah7CM3");
        htemp2->GetXaxis()->SetRangeUser(-7,17);
        htemp2->GetYaxis()->SetRangeUser(3,45);
        cRangle_diff->Update();
        ...
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cut += " && " + cutTriangle1;
        cout << ch1->Draw("thetah7CM:1000*(mh7-4*0.939565-2.808920) >> h_thetah7CM4",cut.Data(),"") << endl;
        htemp2 = (TH2F*)gPad->GetPrimitive("h_thetah7CM4");
        htemp2->GetXaxis()->SetRangeUser(-7,17);
        htemp2->GetYaxis()->SetRangeUser(3,45);
        cRangle_diff->Update();
    ...
    if (tAnglevsMM) {
        ...
        TH2F *hfake_1 = new TH2F("hfake_1","title",10000,-10,19,10000,-1.,1);
        hfake_1->Draw();
        ...
        cut.Form("nh3 && flagCent && nh3 && nhe3_1 && flag1");
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cout << ch1->Draw("cos(thetah3CM*TMath::DegToRad()):1000*(mh7-4*0.939565-2.808920) >> tel1",cut.Data(),"same") << endl;
        c_aCM_dif->Update();     
        ...
        cut.Form("nh3 && flagCent && nh3 && nhe3_2 && flag2");
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cout << ch1->Draw("cos(thetah3CM*TMath::DegToRad()):1000*(mh7-4*0.939565-2.808920) >> tel2",cut.Data(),"same") << endl;
        c_aCM_dif->Update();     
        ...
        cut.Form("nh3 && flagCent && nh3 && nhe3_3 && flag3");
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cout << ch1->Draw("cos(thetah3CM*TMath::DegToRad()):1000*(mh7-4*0.939565-2.808920) >> tel3",cut.Data(),"same") << endl;
        c_aCM_dif->Update();     
        ...
        cut.Form("nh3 && flagCent && nh3 && nhe3_4 && flag4");
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cout << ch1->Draw("cos(thetah3CM*TMath::DegToRad()):1000*(mh7-4*0.939565-2.808920) >> tel4",cut.Data(),"same") << endl;
        c_aCM_dif->Update();     
    ...
    if (h3_binaryAngle_CM) {
        ...
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cut += " && " + cutTriangle;
        ch1->Draw("cos(angle_bin_h3_CM*TMath::DegToRad()) >> bin_angleCM_1(10,-1,1)",cut.Data(),"");
        ...
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cut += " && " + cutTriangle;
        ch1->Draw("cos(angle_bin_h3_CM*TMath::DegToRad()) >> bin_angleCM_2(10,-1,1)",cut.Data(),"");
        cBinary_CM_diff->Update();
        ...
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cut += " && " + cutTriangle;
        ch1->Draw("cos(angle_bin_h3_CM*TMath::DegToRad()) >> bin_angleCM_3(10,-1,1)",cut.Data(),"");
        cBinary_CM_diff->Update();
        ...
        cut += " && (fXt*fXt + fYt*fYt)<9*9 ";
        cut += " && " + cutTriangle;
        ch1->Draw("cos(angle_bin_h3_CM*TMath::DegToRad()) >> bin_angleCM_4(10,-1,1)",cut.Data(),"");
        cBinary_CM_diff->Update();
        ...
        // cut += " && " + cutTriangle2;
        cut += " && 1000*(mh7-4*0.939565-2.808920)>0 && 1000*(mh7-4*0.939565-2.808920)<4.";
        ch1->Draw("cos(angle_bin_h3_CM*TMath::DegToRad()) >> bin_angle(10,-1,1)",cut.Data(),"");
        cBinaryCM->Update();
