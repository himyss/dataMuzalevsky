...
// return;
  ...
  ch->Draw("a20_1_un:a1_1>>id1(500,0.,40,250,0.1,5)","flag1","col");

  // cout << ch->Draw("a20_1:a1_1>>id1_he3(500,1.,40,250,0.1,5)","flag1 && nhe3_1 && nh3 && a20_1+a1_1<22","same") << endl;

  c1->Print("/home/oem/Desktop/pics/exp1904/de_E_1.png");
return;
...
// // return;
 ...
 //    c_arr[i]->cd();
  ...
  //   cut.Form("flag4 && n20_4==%d && X_C<9",i);
  //   hDraw.Form("a20_4:a1_4>>id%d(500,1.,40,250,0.1,5)",i);
  //   ch->Draw(hDraw.Data(),cut.Data(),"col");

  //   ch->SetMarkerColor(kBlack);
  //   cut.Form("nh3 && flag4 && n20_4==%d && X_C<9",i);
  //   hDraw.Form("a20_4:a1_4>>id_%d(500,1.,40,250,0.1,5)",i);
  //   ch->Draw(hDraw.Data(),cut.Data(),"same");

  //   ch->SetMarkerColor(kRed);
  //   cut.Form("nhe3_4 && nh3 && flag4 && n20_4==%d && X_C<9",i);
  //   hDraw.Form("a20_4:a1_4>>id_coin_%d(500,1.,40,250,0.1,5)",i);
  //   ch->Draw(hDraw.Data(),cut.Data(),"same");

  //   c_arr[i]->Update();
  // }

  // c_arr[0]->Print("/home/oem/Desktop/de_E.pdf");
  // c_arr[0]->Print("/home/oem/Desktop/de_E.pdf[");
  // c_arr[0]->Print("/home/oem/Desktop/de_E.pdf");
  // for(Int_t i=1;i<15;i++) {
  //   c_arr[i]->Print("/home/oem/Desktop/de_E.pdf");
  // }
  // c_arr[15]->Print("/home/oem/Desktop/de_E.pdf");
  // c_arr[15]->Print("/home/oem/Desktop/de_E.pdf]");
