...
void selection_6He(Int_t nFile=0) {
  ...
  outPutFileName.Form("/media/ivan/data/exp1904/analysed/novPars/selected/newCal/test/track0/coin6He/h7_ct_%d_cut_newPars.root",nFile);
  ...
  // for(Int_t nentry=0;nentry<10000;nentry++) {     
    ...
    if (nX_C>-1 && nY_C>-1) {
      ...
      calcFrameCoordinates(&frame1X,&frame1Y,171.);
      calcFrameCoordinates(&frame2X,&frame2Y,186.);
...
void calcVectorTel1(Int_t n20, Int_t n1) {
  ...
  TVector3 tel1V;
  tel1V.SetXYZ(x20 - fXt,y1*171./186 - fYt,171.);
...
void calcVectorTel2(Int_t n20, Int_t n1) {
  ...
  TVector3 tel1V;
  tel1V.SetXYZ(x1*171./186 - fXt,y20 - fYt,171);
