...
void selection6Li(Int_t nFile=0) {
  ...
  outPutFileName.Form("/media/ivan/data/exp1904/analysed/novPars/selected/h7_ct_6li_%d_cut.root",nFile);
...
void checkHe3() {
  if(n1_1>-1 && n20_1>-1 && cut6Li->IsInside(a1_1+a20_1_un, a20_1)) {
    nhe3_1 = 1;
  }
  else {
    nhe3_1 = 0;
  ...
  if(n1_2>-1 && n20_2>-1 && cut6Li->IsInside(a1_2+a20_2_un, a20_2)) {
    nhe3_2 = 1;
  }
  else {
    nhe3_2 = 0;
  ...
  if(n1_3>-1 && n20_3>-1 && cut6Li->IsInside(a1_3+a20_3_un, a20_3)) {
    nhe3_3 = 1;
  }
  else {
    nhe3_3 = 0;
  ...
  if(n1_4>-1 && n20_4>-1 && cut6Li->IsInside(a1_4+a20_4_un, a20_4)) {
    nhe3_4 = 1;
  }
  else {
    nhe3_4 = 0;
