...
void convert() {
  ...
  ch->Add("/media/ivan/data/exp1904/digi/h7/h7_ct_1*.root");
...
//--------------------------------------------------------------------------------
  ...
  TFile *fw = new TFile("/media/ivan/data/exp1904/analysed/novPars/calibrated/finalCal/h7_1_cal.root", "RECREATE");
