...
void reco6Li(Int_t nRun=0) {
  ...
  inPutFileName.Form("/media/ivan/data/exp1904/analysed/novPars/calcEnergies/h7_ct_6li_%d_reco_newPars.root",nRun);
  ...
  outPutFileName.Form("/media/ivan/data/exp1904/analysed/novPars/reco/h7_ct_6Li_%d_mm_frame_newPars.root",nRun);
