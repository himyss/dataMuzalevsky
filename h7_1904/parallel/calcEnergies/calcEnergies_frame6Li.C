...
void calcEnergies_frame6Li(Int_t nRun=0) {
  ...
  inPutFileName.Form("/media/ivan/data/exp1904/analysed/novPars/selected/h7_ct_6li_%d_cut.root",nRun);
...
// Si
  ...
  f3HeMylar->SetZP(3., 6.);   //alphas, Z, A
  ...
  f3HeSteel->SetZP(3., 6.);   //alphas, Z, A
  ...
  f3HeTarget->SetZP(3., 6.);   //alphas, Z, A
