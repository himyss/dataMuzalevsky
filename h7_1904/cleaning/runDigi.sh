...
INPUTLMDDIR=/mnt/data/exp1904/ERanalysis/digi
...
OUTPUTROOTDIR=/mnt/data/exp1904/ERanalysis/cleaned

# TODO check that ${OUTPUTROOTDIR} exists ???

# Please specify the input XML configuration file
SETUPFILE=/home/muzalevskii/work/macro/h7_1904/parameters/setupEXP1904_final.xml
...
do
  ...
  OUTPUTFILENAME=${NAME//.digi.root/.cleaned.root}
...
EOF
    ...
    root -l -q 'digicleaner.C('\"$INPUTFILENAME\"','\"$OUTPUTFILENAME\"')' >> ${TEXTOUTFILE} 2> ${TEXTERRFILE} &
