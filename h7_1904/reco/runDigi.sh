...
INPUTLMDDIR=/mnt/data/exp1904/ERanalysis/cleaned
...
OUTPUTROOTDIR=/mnt/data/exp1904/ERanalysis/reco
...
do
  ...
  OUTPUTFILENAME=${NAME//.cleaned.root/.reco.root}
...
EOF
    ...
    root -l -q 'reco.C('\"$INPUTFILENAME\"','\"$OUTPUTFILENAME\"')' #>> ${TEXTOUTFILE} 2> ${TEXTERRFILE} &
    exit
    let iFile++
  fi
done
