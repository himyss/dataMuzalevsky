...
void convert() {
  ...
  ch->Add("/media/analysis_nas/exp201904/digi/h7_ct*");  
...
//--------------------------------------------------------------------------------
  ...
  TFile *fw = new TFile("/media/analysis_nas/exp201904/analysed/h7_all.root", "RECREATE");
...
void readPar(TString fileName,Float_t *par1,Float_t *par2,Int_t size=16){
  ...
  ifstream myfile;
  Int_t count=-2;
  TString file = "/home/muzalevsky/soft/expertroot/input/exp1904_pars" + fileName + ".cal";
