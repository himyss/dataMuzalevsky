...
INPUTLMDDIR=/mnt/data/exp2001/data/raw
...
OUTPUTROOTDIR=/mnt/data/exp2001/data/digi

# TODO check that ${OUTPUTROOTDIR} exists ???

# Please specify the input XML configuration file
SETUPFILE=/home/muzalevskii/work/macro/exp2001/digi/setupEXP2001.xml
...
do
  ...
  OUTPUTFILENAME=${NAME//.root/.digi.root}
...
EOF
    ...
    root -l -q 'digibuilder.C('\"$INPUTFILENAME\"','\"$OUTPUTFILENAME\"')' >> ${TEXTOUTFILE} 2> ${TEXTERRFILE} &
