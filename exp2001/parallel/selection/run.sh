...
INPUTLMDDIR=/mnt/data/exp2001/data/analysed/cal
...
OUTPUTROOTDIR=/mnt/data/exp2001/data/analysed/reco
...
do
  ...
  OUTPUTFILENAME=${NAME//.digi.root/.reco.root}
...
EOF
    ...
    root -l -q 'selection.C('\"$INPUTFILENAME\"','\"$OUTPUTFILENAME\"')' >> ${TEXTOUTFILE} 2> ${TEXTERRFILE} &
