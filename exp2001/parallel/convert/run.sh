...
INPUTLMDDIR=/mnt/data/exp2001/data/digi
...
OUTPUTROOTDIR=/mnt/data/exp2001/data/analysed/cal
...
EOF
    ...
    root -l -q 'convert.C('\"$INPUTFILENAME\"','\"$OUTPUTFILENAME\"')' #>> ${TEXTOUTFILE} 2> ${TEXTERRFILE} &
