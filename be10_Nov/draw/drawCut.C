...
// return;
 ...
 if (he3_2) {
    ...
    { 
      ...
      // cut.Form("n20_1==%d && nhe3_1",i);
      cut += " && nhe3_2";
      hdraw.Form("a20_2:a1_2+a20_2_un>>h%d_he31",i);
      ch->Draw(hdraw.Data(),cut.Data(),"same");
      c_arr[i]->Update();
    ...
    c_arr[0]->Print("/home/ivan/Desktop/de_E_2.pdf");
    c_arr[0]->Print("/home/ivan/Desktop/de_E_2.pdf[");
    c_arr[0]->Print("/home/ivan/Desktop/de_E_2.pdf");
    for(Int_t i=1;i<15;i++) {
      c_arr[i]->Print("/home/ivan/Desktop/de_E_2.pdf");
    }
    c_arr[15]->Print("/home/ivan/Desktop/de_E_2.pdf");
    c_arr[15]->Print("/home/ivan/Desktop/de_E_2.pdf]");
  }

   if (he3_3) {
    TCanvas *c3h_3 = new TCanvas("c3h_3","",1800,1000);
    ...
    { 
      ...
      // cut.Form("n20_1==%d && nhe3_1",i);
      cut += " && nhe3_3";
      hdraw.Form("a20_3:a1_3+a20_3_un>>h%d_he31",i);
      ch->Draw(hdraw.Data(),cut.Data(),"same");
      c_arr[i]->Update();
    ...
    c_arr[0]->Print("/home/ivan/Desktop/de_E_3.pdf");
    c_arr[0]->Print("/home/ivan/Desktop/de_E_3.pdf[");
    c_arr[0]->Print("/home/ivan/Desktop/de_E_3.pdf");
    for(Int_t i=1;i<15;i++) {
      c_arr[i]->Print("/home/ivan/Desktop/de_E_3.pdf");
    }
    c_arr[15]->Print("/home/ivan/Desktop/de_E_3.pdf");
    c_arr[15]->Print("/home/ivan/Desktop/de_E_3.pdf]");
  }
   ...
   if (he3_4) {
    ...
    c_arr[0]->Print("/home/ivan/Desktop/de_E_4.pdf");
    c_arr[0]->Print("/home/ivan/Desktop/de_E_4.pdf[");
    c_arr[0]->Print("/home/ivan/Desktop/de_E_4.pdf");
    for(Int_t i=1;i<15;i++) {
      c_arr[i]->Print("/home/ivan/Desktop/de_E_4.pdf");
    }
    c_arr[15]->Print("/home/ivan/Desktop/de_E_4.pdf");
    c_arr[15]->Print("/home/ivan/Desktop/de_E_4.pdf]");
  }
