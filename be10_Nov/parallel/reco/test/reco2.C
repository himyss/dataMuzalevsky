...
void reco2() {
  ...
  // ch->Add("/media/ivan/data/exp1906/be10/analysed/novPars/calcEnergies/parVariation/sideTel/be10_ct_second_reco.root");
  ch->Add("/media/ivan/data/exp1906/be10/analysed/novPars/calcEnergies/be10_ct_second_reco.root");
  ...
  // TFile *fw = new TFile("/media/ivan/data/exp1906/be10/analysed/novPars/reco/parVariation/sideTel/be10_ct_mm_secondVol.root", "RECREATE");
  TFile *fw = new TFile("/media/ivan/data/exp1906/be10/analysed/novPars/reco/be10_ct_mm_secondVol.root", "RECREATE");
