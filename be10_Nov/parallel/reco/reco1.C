...
Float_t mh7,eh7,eh3,ehe3,ehe8,eh3_CM,ehe8_ToF;
...
void reco1() {
  ...
  f8HeSi.SetEtab(200000, 500.); // ?, MeV calculate ranges
  f8HeSi.SetDeltaEtab(300);

  TChain *ch = new TChain("tree");
  ch->Add("/media/ivan/data/exp1906/be10/analysed/novPars/calcEnergies/parVariation/sideTel/be10_ct_firstVol_reco.root");
  // ch->Add("/media/ivan/data/exp1906/be10/analysed/novPars/calcEnergies/be10_ct_firstVol_reco.root");
  ...
  TFile *fw = new TFile("/media/ivan/data/exp1906/be10/analysed/novPars/reco/parVariation/sideTel/be10_ct_firstVol_mm.root", "RECREATE");
  // TFile *fw = new TFile("/media/ivan/data/exp1906/be10/analysed/novPars/reco/be10_ct_firstVol_mm.root", "RECREATE");
  ...
  tw->Branch("ehe8_ToF.",&ehe8_ToF,"ehe8_ToF/F");
