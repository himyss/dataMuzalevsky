...
void reco() {
  ...
  ch->Add("/media/ivan/data/exp1906/be10/analysed/novPars/calcEnergies/parVariation/sideTelOffset/be10_ct_firstVol_reco_Y2.root");
  ...
  TFile *fw = new TFile("/media/ivan/data/exp1906/be10/analysed/novPars/reco/parVariation/sideTelOffset/be10_ct_mm_first_Y2.root", "RECREATE");
