...
void reco1() {
  ...
  ch->Add("/media/ivan/data/exp1906/be10/analysed/novPars/calcEnergies/parVariation/sideTelOffset/be10_ct_secondVol_reco_Y_4.root");
  ...
  TFile *fw = new TFile("/media/ivan/data/exp1906/be10/analysed/novPars/reco/parVariation/sideTelOffset/be10_ct_mm_second_Y_4.root", "RECREATE");
