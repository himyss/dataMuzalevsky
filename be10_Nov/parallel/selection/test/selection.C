...
void selection(Int_t nFile=0) {
  ...
  inPutFileName.Form("/media/ivan/data/exp1906/be10/analysed/novPars/calibrated/be10_thinTarget_new.root");
  ...
  outPutFileName.Form("/media/ivan/data/exp1906/be10/analysed/novPars/selection/be10_ct_thinTarget_cut.root");
  // outPutFileName.Form("/media/ivan/data/exp1906/be10/analysed/novPars/selection/parVariation/sideTel/be10_ct_thinTarget_cut.root");
  

  // outPutFileName.Form("test.root",nFile);
  ...
  // for(Int_t nentry=0;nentry<1000000;nentry++) {     
    ...
    if (n20_4>-1 && n1_4>-1) calcVectorTel4(n20_4, n1_4);
...
void CsItimes() {
  ...
  // if(nCsI_track>-1 && trCsI[nCsI_track]-tF5>300 && trCsI[nCsI_track]-tF5<600 ) { 
    return;
  }
  else {
    flagCent = 0;  
...
void calcVectorTel1(Int_t n20, Int_t n1) {
  ...
  TVector3 tel1V;
  tel1V.SetXYZ(x20 - fXt,(y1 - fYt)*173./188.,173.);

  x1t = x20;
  y1t = (y1 - fYt)*173./188. + fYt;
...
void calcVectorTel2(Int_t n20, Int_t n1) {
  ...
  TVector3 tel1V;
  tel1V.SetXYZ(173./188.*(x1 - fXt),y20 - fYt,173.);

  x2t = 173./188.*(x1 - fXt) + fXt;
  y2t = y20;
...
void calcVectorTel4(Int_t n20, Int_t n1) {
  ...
  TVector3 tel1V;
  tel1V.SetXYZ((x1 - fXt)*173./188.,y20 - fYt,173.);

  x4t = (x1 - fXt)*173./188. + fXt;
  y4t = y20;
