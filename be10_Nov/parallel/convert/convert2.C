...
void convert2() {
  ...
  ch->Add("/media/ivan/data/exp1906/be10/digi/all/noVeto/secondVol/be10_ct*");
...
//--------------------------------------------------------------------------------
  ...
  TFile *fw = new TFile("/media/ivan/data/exp1906/be10/analysed/novPars/calibrated/test/be10_secondVol.root", "RECREATE");
