...
void convert3() {
  ...
  ch->Add("/media/ivan/data/exp1906/be10/digi/all/noVeto/thinTarget/be10_ct*");
...
//--------------------------------------------------------------------------------
  ...
  TFile *fw = new TFile("/media/ivan/data/exp1906/be10/analysed/novPars/calibrated/test/be10_thinTarget.root", "RECREATE");
  ...
  // beamdet
    ...
    if (tMWPC[2] - tF5 > 86 || tMWPC[2] - tF5 < 64) continue;
    if (tMWPC[3] - tF5 > 80 || tMWPC[3] - tF5 < 60) continue;
    ...
    fillSi(v_SSD_1,SSD1,tSSD1,pSSD1_1,pSSD1_2,&mult1_1,0.3);
    ...
    fillSi(v_SSD_2,SSD2,tSSD2,pSSD2_1,pSSD2_2,&mult1_2,0.3);
    ...
    fillSi(v_SSD_3,SSD3,tSSD3,pSSD3_1,pSSD3_2,&mult1_3,0.3);
    ...
    fillSi(v_SSD_4,SSD4,tSSD4,pSSD4_1,pSSD4_2,&mult1_4,0.3);
