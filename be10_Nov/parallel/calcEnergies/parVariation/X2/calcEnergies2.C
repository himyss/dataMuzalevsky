...
void calcEnergies2() {
  ...
  ch->Add("/media/ivan/data/exp1906/be10/analysed/novPars/selection/parVariation/sideTelOffset/be10_ct_secondVol_cut_X2.root");
  ...
  TFile *fw = new TFile("/media/ivan/data/exp1906/be10/analysed/novPars/calcEnergies/parVariation/sideTelOffset/be10_ct_secondVol_reco_X2.root", "RECREATE");
