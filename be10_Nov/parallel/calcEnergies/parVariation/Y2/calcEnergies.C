...
void calcEnergies() {
  ...
  ch->Add("/media/ivan/data/exp1906/be10/analysed/novPars/selection/parVariation/sideTelOffset/be10_ct_firstVol_cut_Y2.root");
  ...
  TFile *fw = new TFile("/media/ivan/data/exp1906/be10/analysed/novPars/calcEnergies/parVariation/sideTelOffset/be10_ct_firstVol_reco_Y2.root", "RECREATE");
