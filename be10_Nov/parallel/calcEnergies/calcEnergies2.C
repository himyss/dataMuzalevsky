...
void calcEnergies2() {
  ...
  TFile *fw = new TFile("/media/ivan/data/exp1906/be10/analysed/novPars/calcEnergies/parVariation/sideTel/be10_ct_second_reco.root", "RECREATE");
  // TFile *fw = new TFile("/media/ivan/data/exp1906/be10/analysed/novPars/calcEnergies/be10_ct_second_reco.root", "RECREATE");
