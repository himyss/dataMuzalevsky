#include "/home/ivan/work/macro/be10_Nov/cut/create_cuts.C"
...
#include "/home/ivan/work/macro/be10_Nov/parallel_new/reco/recoInput.h"
#include "/home/ivan/work/macro/be10_Nov/parallel_new/reco/recoOutput.h"
...
void recoVar(TString InFile, TString OutFile) {
  ...
  f10BeSi.SetEL(1, 2.321); // density in g/cm3
  f10BeSi.AddEL(14., 28.086, 1);  //Z, mass
  f10BeSi.SetZP(4., 10.);   //alphas, Z, A
  f10BeSi.SetEtab(300000, 250.); // ?, MeV calculate ranges
  f10BeSi.SetDeltaEtab(300);

  TChain *ch = new TChain("tree");
  // TString inPutFileName;
  // inPutFileName.Form("/mnt/data/exp1904/analysed/calcEnergies/h7/h7_ect_%d_reco.root",nRun);
  ch->Add(InFile.Data());;
  ...
  // outPutFileName.Form("/mnt/data/exp1904/analysed/reco/tmp/h7_ect_%d_mm.root",nRun);
...
// Lorentz Vectors
  ...
  tw->Branch("lv_be10","TLorentzVector",&lv_be10);
  tw->Branch("lv_be10_CMR","TLorentzVector",&lv_be10_CMR);
	
  tw->Branch("lv_li9","TLorentzVector",&lv_li9);
  tw->Branch("lv_he3","TLorentzVector",&lv_he3);
  tw->Branch("lv_li9_CMR","TLorentzVector",&lv_li9_CMR);

  tw->Branch("lv_he4","TLorentzVector",&lv_he4);
  tw->Branch("lv_li8","TLorentzVector",&lv_li8);
  tw->Branch("lv_li8_CMR","TLorentzVector",&lv_li8_CMR);
...
// h7
  tw->Branch("angle_he3_9li",&angle_he3_9li,"angle_he3_9li/F");
  tw->Branch("angle_he3_be10",&angle_he3_be10,"angle_he3_be10/F");
  tw->Branch("angle_9li_be10",&angle_9li_be10,"angle_9li_be10/F");
  tw->Branch("angle_9li_beam_CMR",&angle_9li_beam_CMR,"angle_9li_beam_CMR/F");  

// h6
  tw->Branch("angle_he4_8li",&angle_he4_8li,"angle_he4_8li/F");
  tw->Branch("angle_he4_be10",&angle_he4_be10,"angle_he4_be10/F");
  tw->Branch("angle_8li_beam_CMR",&angle_8li_beam_CMR,"angle_8li_beam_CMR/F");
...
// Floats
  ...
  for(Int_t nentry = 0; nentry<ch->GetEntries();nentry++) {
    ...
    lv_be10_CMR = lv_be10;
    lv_be10_CMR.Boost(-bVect_R);

    neutronID();

    if (flagCent && ( ( nhe3_1 && flag1) || (nhe3_2 && flag2) || (nhe3_3 && flag3) || (nhe3_4 && flag4) )) { // reco 7H
      reco9Li();
    }

    if (flagCent && ( ( nhe4_1 && flag1) || (nhe4_2 && flag2) || (nhe4_3 && flag3) || (nhe4_4 && flag4) )) { // reco 7H
      reco8Li();
    }
...
void calculateBeam() {
  ...
  kinEnergy =  f10BeSi.GetE(1000*kinEnergy, 540.)/1000.;
  ...
  lv_be10.SetXYZM(pBeam*TMath::Sin(theta)*TMath::Cos(phi), pBeam*TMath::Sin(theta)*TMath::Sin(phi), pBeam*TMath::Cos(theta) ,mass);

}

void zerovars() {

  lv_be10.SetXYZT(0,0,0,0);
  lv_li9.SetXYZT(0,0,0,0);
  lv_he3.SetXYZT(0,0,0,0);
  lv_li8.SetXYZT(0,0,0,0);

  lv_li9_CMR.SetXYZT(0,0,0,0);
  lv_li8_CMR.SetXYZT(0,0,0,0);
  lv_be10_CMR.SetXYZT(0,0,0,0);
  ...
  angle_he4_8li = -1;
  angle_he4_be10 = -1;
  angle_9li_beam_CMR = -1;
  angle_8li_beam_CMR = -1;
...
void neutronID() {
  ...
  for (Int_t i=0;i<32;i++) {
    if (cutGamma->IsInside(ND_amp[i] , ND_tac[i])) {      
      ...
      if (velocity>299.792458) continue;
      numND = i;
      Double_t beta = sqrt(1 - (velocity*velocity/(299.792458*299.792458) ) );
  ...
  if ((neutron==1 && gammma==0) || (gammma==1 && neutron==0)) {
  // if ((neutron==1 && gammma==0)) {
  // if ((gammma==1 && neutron==0)) {
    TVector3 dir;
    ...
    // cout << lv_neutron.T()-lv_neutron.Mag() << endl;
  }
...
void reco9Li() {
  ...
  lv_li9 = lv_be10 + lv_d2 + (-lv_he3);
  lv_li9_CMR = lv_li9;
  lv_li9_CMR.Boost(-bVect_R);

  // bVect_7H = lv_h7.BoostVector();

  angle_he3_9li = lv_li9.Angle(lv_he3.Vect())*TMath::RadToDeg();

  angle_he3_be10 = lv_be10.Angle(lv_he3.Vect())*TMath::RadToDeg();
  angle_9li_be10 = lv_be10.Angle(lv_li9.Vect())*TMath::RadToDeg();
  
  angle_9li_beam_CMR = lv_be10_CMR.Angle(lv_li9_CMR.Vect())*TMath::RadToDeg();  
...
void reco8Li() {
  ...
  lv_li8 = lv_be10 + lv_d2 + (-lv_he4);
  lv_li8_CMR = lv_li8;
  lv_li8_CMR.Boost(-bVect_R);

  // bVect_7H = lv_h7.BoostVector();

  angle_he4_8li = lv_li8.Angle(lv_he4.Vect())*TMath::RadToDeg();

  angle_he4_be10 = lv_be10.Angle(lv_he4.Vect())*TMath::RadToDeg();
  
  angle_8li_beam_CMR = lv_be10_CMR.Angle(lv_li8_CMR.Vect())*TMath::RadToDeg();  
