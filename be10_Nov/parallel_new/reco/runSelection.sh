...
INPUTLMDDIR=/media/ivan/data/exp1906/analysed/calcEnergies
...
OUTPUTROOTDIR=/media/ivan/data/exp1906/analysed/reco
...
EOF
    ...
    root -l -q 'recoVar.C('\"$INPUTFILENAME\"','\"$OUTPUTFILENAME\"')' >> ${TEXTOUTFILE} 2> ${TEXTERRFILE} &
