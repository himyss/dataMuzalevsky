...
void testE() {
  ...
  // e_1 = f3HeSi->GetE(a1_1,1.5) + a20_1_un; // 4 micron - DL between thin and thick sensitive areas (DL thin about 1 mik)
  // e_1 = f3HeSi->GetE(e_1,0.5); //dl of thin det



  // // mylar
  // thickness = 3.5/cos(v_he3_1);
  // e_1 = f3HeMylar->GetE0(e_1,thickness);

  // // steel
  // thickness = 6./cos(v_he3_1);
  // e_1 = f3HeSteel->GetE0(e_1,thickness);

  e_1 = 6;

  thickness = 3000/cos(15*TMath::DegToRad());
  e_1 = f3HeTarget->GetE(e_1,thickness);
  cout << e_1 << endl;

  thickness = 6/cos(15*TMath::DegToRad());
  e_1 = f3HeSteel->GetE(e_1,thickness);
  cout << e_1 << endl;

  thickness = 3.5/cos(15*TMath::DegToRad());
  e_1 = f3HeMylar->GetE0(e_1,thickness); 
  cout << e_1 << endl;

  e_1 = f3HeMylar->GetE(e_1,20/cos(15*TMath::DegToRad()));
  cout << e_1 << endl; 
...
/*
  ...
  ch->SetBranchAddress("v_he3_1.",&v_he3_1);
  ch->SetBranchAddress("v_he3_2.",&v_he3_2);
  ch->SetBranchAddress("v_he3_3.",&v_he3_3);
  ch->SetBranchAddress("v_he3_4.",&v_he3_4);

  TFile *fw = new TFile("/home/oem/work/data/exp1906/analysed/be_10_reco.root", "RECREATE");
  ...
  for(Int_t nentry = 0; nentry<ch->GetEntries();nentry++) {
    ...
    if(nhe3_1) {
      ...
      e_1 = f3HeSi->GetE0(a1_1,1.5) + a20_1_un; // 4 micron - DL between thin and thick sensitive areas (DL thin about 1 mik)
      e_1 = f3HeSi->GetE0(e_1,0.5); //dl of thin det
      ...
      // deuterium target
      thickness = 3000./cos(v_he3_1);
      e_1 = f3HeTarget->GetE0(e_1,thickness);
    }

    if(nhe3_2) {
      // Si
      e_2 = f3HeSi->GetE0(a1_2,1.5) + a20_2_un; // 4 micron - DL between thin and thick sensitive areas (DL thin about 1 mik)
      e_2 = f3HeSi->GetE0(e_2,0.5); //dl of thin det

      // mylar
      thickness = 3.5/cos(v_he3_2);
      e_2 = f3HeMylar->GetE0(e_2,thickness);

      // steel
      thickness = 6./cos(v_he3_2);
      e_2 = f3HeSteel->GetE0(e_2,thickness);

      // deuterium target
      thickness = 3000./cos(v_he3_2);
      e_2 = f3HeTarget->GetE0(e_2,thickness);
    }

    if(nhe3_3) {
      // Si
      e_3 = f3HeSi->GetE0(a1_3,1.5) + a20_3_un; // 4 micron - DL between thin and thick sensitive areas (DL thin about 1 mik)
      e_3 = f3HeSi->GetE0(e_3,0.5); //dl of thin det

      // mylar
      thickness = 3.5/cos(v_he3_3);
      e_3 = f3HeMylar->GetE0(e_3,thickness);

      // steel
      thickness = 6./cos(v_he3_3);
      e_3 = f3HeSteel->GetE0(e_3,thickness);

      // deuterium target
      thickness = 3000./cos(v_he3_3);
      e_3 = f3HeTarget->GetE0(e_3,thickness);
    }

    if(nhe3_4) {
      // Si
      e_4 = f3HeSi->GetE0(a1_4,1.5) + a20_4_un; // 4 micron - DL between thin and thick sensitive areas (DL thin about 1 mik)
      e_4 = f3HeSi->GetE0(e_4,0.5); //dl of thin det

      // mylar
      thickness = 3.5/cos(v_he3_4);
      e_4 = f3HeMylar->GetE0(e_4,thickness);

      // steel
      thickness = 6./cos(v_he3_4);
      e_4 = f3HeSteel->GetE0(e_4,thickness);

      // deuterium target
      thickness = 3000./cos(v_he3_4);
