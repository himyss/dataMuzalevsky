...
void calcEnergies() {
  ...
  // ch->Add("/media/ivan/data/exp1906/be10/analysed/full_data/be10_*");
  ...
  // ch->Add("/media/ivan/data/exp1906/be10/analysed/novPars/selection/be10_cut_firstVol.root");
  ...
  TFile *fw = new TFile("/media/ivan/data/exp1906/be10/analysed/novPars/reco/be10_ct_thick_reco.root", "RECREATE");
...
// Si
  ...
  f3HTarget->SetEL(1, 0.0010049); // density in g/cm3
