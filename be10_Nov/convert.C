...
void convert() {
  ...
  ch->Add("/media/ivan/data/exp1906/be10/digi/all/noVeto/firstVol/be*");
  // ch->Add("/media/ivan/data/exp1906/be10/raw/tmp/be10_ct_05_0002_digi.root");
...
//--------------------------------------------------------------------------------
  ...
  TFile *fw = new TFile("/media/ivan/data/exp1906/be10/raw/tmp/be10_ct_05_0002_cal.root", "RECREATE");
  // ch->Add("");
