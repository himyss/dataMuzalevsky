...
void selection() {
  ...
  TFile *fw = new TFile("/media/ivan/data/exp1906/be10/analysed/novPars/selection/be10_cut_firstVol.root", "RECREATE");
...
void readThickness() {
  ...
  TFile *f1 = new TFile("/home/ivan/work/soft/er/input/novPars/thicknessMap_calib_90_all_SSD_1m_1_new.root","READ");
  if (f1->IsZombie()) {
  ...
  TFile *f2 = new TFile("/home/ivan/work/soft/er/input/novPars/thicknessMap_calib_90_all_SSD_1m_2_new.root","READ");
  if (f2->IsZombie()) {
    for(Int_t i = 0; i<16; i++) {
      for(Int_t j = 0; j<16; j++) {
        fThickness2[i][j] = 20.;
  ...
  TFile *f3 = new TFile("/home/ivan/work/soft/er/input/novPars/thicknessMap_calib_90_all_SSD_1m_3_new.root","READ");
  if (f3->IsZombie()) {
    for(Int_t i = 0; i<16; i++) {
      for(Int_t j = 0; j<16; j++) {
        fThickness3[i][j] = 20.;
  ...
  TFile *f4 = new TFile("/home/ivan/work/soft/er/input/novPars/thicknessMap_calib_90_all_SSD_1m_4_new.root","READ");
  if (f4->IsZombie()) {
    for(Int_t i = 0; i<16; i++) {
      for(Int_t j = 0; j<16; j++) {
        fThickness4[i][j] = 20.;
