...
void convert_all() {
  ...
  // ch->Add("/home/oem/work/data/exp1811/digi/notarget/alltriggers/he8*");
...
//--------------------------------------------------------------------------------
  ...
  TFile *fw = new TFile("/home/oem/work/data/exp1811/calibration/CsI/he8.root", "RECREATE");
  ...
  // for(Int_t nentry=0;nentry<1000000;nentry++) {    
    ...
    if (v_DSDX_C->GetEntries()==0 || v_DSDY_C->GetEntries()==0 || v_CsI->GetEntries()==0) continue;
