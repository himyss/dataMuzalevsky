...
void findpedestalsDigi() {
  
  readPar("SSD20_L",oldpar1,oldpar2);

  TChain *ch2 = new TChain("tree"); //e4
  ch2->Add("/home/oem/work/data/exp1811/analysed/clb/dsd_20_l_03.root");
  ch2->SetLineWidth(2.);
  ...
  for(Int_t i=0;i<16;i++) {
    ...
    hDraw.Form("SSD20_L[%d]>>h%d_ped(39,1,40)",i,i);
    ch2->Draw(hDraw.Data(),"","");
  ...
  ofstream outcalfile;
  outcalfile.open("/home/oem/work/data/exp1811/calibration/SSD20L/pedestals_digi.cal");
