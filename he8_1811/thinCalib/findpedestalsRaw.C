...
void findpedestalsRaw() {
  ...
  for(Int_t i=0;i<16;i++) {
    ...
    hCut.Form("Right_telescope_SSD20_R.fData.fStChannel==%d && Right_telescope_tSSD20_R.@fData.GetEntries()==0",i);
    hDraw.Form("Right_telescope_SSD20_R.fData.fValue>>h%d_ped(40,0,40)",i);
  ...
  ofstream outcalfile;
  outcalfile.open("/home/oem/work/data/exp1811/calibration/SSD20L/pedestals_right.cal");
